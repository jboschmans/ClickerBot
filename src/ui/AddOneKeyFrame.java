...
public class AddOneKeyFrame extends javax.swing.JFrame {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        if(number == -1)
            DomainController.addEvent(ty, minPause, maxPause, 0, 0, false, false, false, k, "");
        else
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddOneKeyFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddOneKeyFrame().setVisible(true);
            }
        });
    }
