...
public class AddMoveMousePlusClickFrame extends javax.swing.JFrame implements KeyListener {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        else
        {
            ...
            if (number == -1)
                DomainController.addEvent(domain.Event.Type.MOVEMOUSEPLUSCLICK, minPause, maxPause, x, y, jRadioButtonLeft.isSelected(), jRadioButtonRight.isSelected(), jRadioButtonMiddle.isSelected(), "", "");
            else
            {
